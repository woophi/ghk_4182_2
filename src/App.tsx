...
const optionsGroup2 = [
  {
    ...
    description: 'Получайте доход с остатков денежных средств на брокерском счете',
  },
  {
...
const optionsGroup3 = [
  {
    title: 'Узнавайте, куда инвестируют топовые трейдеры',
  ...
  {
    title: 'Общайтесь с экспертами в закрытых сообществах',
